...
public class C08AssertionInfo {
    ...
    public void hardAssertion(){
        ...
        System.out.println("Testing eaquality of 3=3");
        ...
        Assert.assertEquals(3,3);//this line won't be executed as the program crashes after a hard assertion failure
    ...
    public void softAssertion(){
        ...
        System.out.println("Testing equality of 3=5");
        sa.assertEquals(3,5);//passed

        sa.assertAll();// If not used, all assertions are written in vain.
